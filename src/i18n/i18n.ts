...
const translations = {
  en: {
    ...
    figureLibraryResults: "figures",
    figureLibraryEmptyTitle: "No figures found",
    figureLibraryEmptyBody: "Try another search term.",
    ...
    slalomFirstConeDirection: "First cone direction",
    slalomFirstConeLeft: "First cone faces left",
    slalomFirstConeRight: "First cone faces right",
    wechseltorMiddleGap: "Middle gate distance",
    kreiselEntryExitConeCount: "Cones between entry and exit",
    sSpurgasseCurveAmount: "Curve strength",
    sSpurgasseLengthMeters: "Length (m)",
    zGasseGateGap: "Distance between gates (m)",
    zGasseMiddleGateOffset: "Middle gate offset",
    zGasseMiddleGateOffsetUp: "Up by one cone",
    zGasseMiddleGateOffsetNone: "No offset",
    zGasseMiddleGateOffsetDown: "Down by one cone",
    spurgasseGeradeLengthMeters: "Length (m)",
    gasseConeCount: "Cones per side",
  ...
  de: {
    ...
    figureLibraryResults: "Figuren",
    figureLibraryEmptyTitle: "Keine Figuren gefunden",
    figureLibraryEmptyBody: "Versuche einen anderen Suchbegriff.",
    ...
    slalomFirstConeDirection: "Richtung der ersten Pylone",
    slalomFirstConeLeft: "Erste Pylone zeigt nach links",
    slalomFirstConeRight: "Erste Pylone zeigt nach rechts",
    wechseltorMiddleGap: "Mittelabstand",
    kreiselEntryExitConeCount: "Pylonen zwischen Ein- und Ausfahrt",
    sSpurgasseCurveAmount: "Kurvenstärke",
    sSpurgasseLengthMeters: "Länge (m)",
    zGasseGateGap: "Abstand zwischen den Gassen (m)",
    zGasseMiddleGateOffset: "Mittlere Gasse versetzen",
    zGasseMiddleGateOffsetUp: "Eine Pylone nach oben",
    zGasseMiddleGateOffsetNone: "Kein Versatz",
    zGasseMiddleGateOffsetDown: "Eine Pylone nach unten",
    spurgasseGeradeLengthMeters: "Länge (m)",
    gasseConeCount: "Pylonen pro Seite",
